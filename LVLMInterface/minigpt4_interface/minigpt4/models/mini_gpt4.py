...
from LVLMInterface.minigpt4_interface.minigpt4.models.blip2 import (
    Blip2Base,
    disabled_train,
)
from LVLMInterface.minigpt4_interface.minigpt4.models.modeling_llama import (
    LlamaForCausalLM,
)
...
class MiniGPT4(Blip2Base):
    ...
    def __init__(
        ...
        q_former_model="/data/hcd/Q-former/blip2_pretrained_flant5xxl.pth",
        img_size=224,
        drop_path_rate=0,
